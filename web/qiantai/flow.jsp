...
<div class="flowBox">
	...
	<form id="formCart" name="formCart" method="post" action="${pageContext.request.contextPath}/qt/goodsvl?bs=updateGood">
		<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			...
			<tr>
				<td bgcolor="#ffffff" align="center">${good.id}<input type="hidden" name="id" value="${good.id}"/></td>
				<td bgcolor="#ffffff" align="center">${good.goodname}</td>
				<td bgcolor="#ffffff" align="center">${good.price}</td>
				<td bgcolor="#ffffff" align="center"><input type="text" name="amount" value="${good.amount}"/></td>
				<td bgcolor="#ffffff" align="center">${good.amount*good.price}</td>
				<td bgcolor="#ffffff" align="center"><a href="${pageContext.request.contextPath}/qt/goodsvl?bs=delGood&id=${good.id}">删除</a></td>
			</tr>
			</c:forEach>
		</table>
		<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
			<tr>
				<td bgcolor="#ffffff">
					购物金额总计计 ￥${sessionScope.toAccount}元
				</td>
				<td align="right" bgcolor="#ffffff">
					<a href="${pageContext.request.contextPath}/qt/goodsvl?bs=clear"><input type="button" value="清空购物车" class="bnt_blue_1" onclick="" /></a>
	...
	<table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
		<tr>
			<td bgcolor="#ffffff">
				<a href="../qt/goodsvl?bs=open"><img src="${pageContext.request.contextPath}/qiantai/images/continue.gif" alt="continue" /></a>
			</td>
			<td bgcolor="#ffffff" align="right">
				<a href="flow.php-step=checkout.htm"><img src="${pageContext.request.contextPath}/qiantai/images/checkout.gif" alt="checkout" /></a>
			</td>
		</tr>
	</table>
</div>
